...
from modules.common.misc import get_speed
from modules.sensing.perception import sensor_transformation as st
...
class DataDumper(object):
    ...
    Parameters
    ----------
    perception_manager : modules object
    ...
    ----------
    rgb_camera : list
        A list of modules.CameraSensor that containing all rgb sensor data
        of the managed vehicle.

    lidar ; modules object
    ...
    def __init__(self,
        ...
        base_dump_dir = os.getenv('DATA_DUMP_DIR') or \
            os.path.join(current_path, '../../../data_dumping')
        self.save_parent_folder = os.path.join(base_dump_dir,
                                               save_time,
                                               str(self.vehicle_id))
    ...
    def run_step(self,
        ...
        ----------
        perception_manager : modules object
            simulator modules perception manager.

        localization_manager : modules object
            simulator modules localization manager.

        behavior_agent : modules object
            Open
        """
        self.count += 1
    ...
    def save_yaml_file(self,
        ...
        behavior_agent : modules object
            simulator modules behavior agent.
        """
        frame = count
