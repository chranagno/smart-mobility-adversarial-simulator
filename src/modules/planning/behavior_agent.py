...
from modules.common.misc import get_speed, positive, cal_distance_angle
from modules.planning.collision_check import CollisionChecker
from modules.planning.local_planner_behavior import LocalPlanner
from modules.planning.global_route_planner import GlobalRoutePlanner
from modules.planning.global_route_planner_dao import GlobalRoutePlannerDAO
from modules.planning.planer_debug_helper import PlanDebugHelper
...
class BehaviorAgent(object):
    ...
    white_list : list
        The white list contains allowed vehicle positions.
    ...
    def run_step(
        ...
        lane_change_allowed : boolean
            Whether lane change is allowed. This is passed by the caller.
