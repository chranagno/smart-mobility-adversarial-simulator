...
from modules.common.misc import distance_vehicle, draw_trajetory_points, \
    cal_distance_angle, compute_distance
from modules.planning.spline import Spline2D
...
class LocalPlanner(object):
    ...
    def run_step(
        ...
        trajectory : list
            Pre-generated car-following trajectory for controlled following.
        ...
        # Generate a trajectory only when it is not externally provided by a
        # controlled following mode.
