...
import modules.sensing.perception.sensor_transformation as st
from modules.common.misc import \
    cal_distance_angle, get_speed, get_speed_sumo
from modules.sensing.perception.obstacle_vehicle import \
    ObstacleVehicle
from modules.sensing.perception.static_obstacle import TrafficLight
from modules.sensing.perception.o3d_lidar_libs import \
...
class PerceptionManager:
    ...
    def __init__(self, vehicle, config_yaml, cav_world,
        ...
        if self.activate or self.lidar_visualize or data_dump:
    ...
    def deactivate_mode(self, objects):
        ...
        # convert carla.Vehicle to modules.ObstacleVehicle if lidar
