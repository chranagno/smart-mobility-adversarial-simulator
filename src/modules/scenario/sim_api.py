...
from modules.common.vehicle_manager import VehicleManager
from modules.common.rsu_manager import RSUManager
from modules.scenario.custom_map import \
...
class ScenarioManager:
    ...
    def __init__(self, scenario_params,
        ...
        carla_cfg = scenario_params.get('carla', {})
        carla_host = carla_cfg.get('host', '127.0.0.1')
        carla_port = carla_cfg.get('port', 2000)
        ...
        if xodr_path:
            ...
            for attempt in range(6):
                try:
                    ...
                    print(f"Attempt {attempt+1}/6: CARLA not ready or {town} not loaded. Retrying in 5s...")
                    time.sleep(5.0)
            if not self.world:
                print(
    ...
    def create_vehicle_manager(self, application,
        ...
        ----------
        application : list
            The application purpose, for example ['single'].
