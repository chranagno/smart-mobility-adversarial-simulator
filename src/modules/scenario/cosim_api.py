...
from modules.co_simulation.sumo_integration.constants import SPAWN_OFFSET_Z
from modules.co_simulation.sumo_integration.bridge_helper import BridgeHelper
from modules.co_simulation.sumo_integration.constants import INVALID_ACTOR_ID
from modules.co_simulation.sumo_integration.sumo_simulation import \
    SumoSimulation
from modules.scenario.sim_api import ScenarioManager
...
class CoScenarioManager(ScenarioManager):
    ...
    xodr_path : str
        The xodr file to the custom map, default: None.

    town : str
        Town name if not using custom map, eg. 'Town06'.
    ...
    def __init__(self, scenario_params, apply_ml, carla_version,
        ...
        sumo_step_length = scenario_params['world']['fixed_delta_seconds']
